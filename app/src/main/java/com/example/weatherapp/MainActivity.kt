...
import android.text.TextDirectionHeuristics.LOCALE
...
class MainActivity : AppCompatActivity() {
    ...
    val API : String = "f0d61605b32373451948a31f03b9fa9f"
    ...
    inner class weatherTask(): AsyncTask<String , Void , String>()
    {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try{
                ...
                val tempMin = "Min Temp: "+ main.get("temp_min") +"°C"
                val tempMax = "Max Temp: "+ main.get("temp_max") +"°C"
